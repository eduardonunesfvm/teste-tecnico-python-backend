...
Conforme solicitado nas regras do desafio, descrevo abaixo como utilizei ferramentas de IA durante o desenvolvimento — com foco em **decisões técnicas**, não em geração automática de código.
...
> Os artefatos das conversas com IA estão disponíveis na pasta `/docs` do repositório.
